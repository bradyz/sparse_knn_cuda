...
knn_kernel.o: knn_kernel.cpp
	g++ -std=c++11 -c knn_kernel.cpp
...
run: dense_matrix.o sparse_matrix.o knn_kernel.o main.o
	g++ -std=c++11 -Wall main.o dense_matrix.o sparse_matrix.o knn_kernel.o -o main.out
